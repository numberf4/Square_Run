...
local function onFinishLineCollision(event)
    ...
    attempt = display.newText( tostring(currentAttempt), 100, 30, "assets/font/JosefinSans-Regular.ttf", 19 )
    attempt:setFillColor( 0.0, 0.7, 0.9 )
    sceneGroup:insert(attempt)
    
    completion = display.newText( tostring(currentPercent) .. "%", 380, 30, "assets/font/JosefinSans-Regular.ttf", 19 )
